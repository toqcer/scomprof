                ...
                <div class="col-12">
                    <div class="owl-carousel owl-stage-outer">
                        <div class="item">
                            <div class="team-card">
                                <div class="image-team">
                                    <img src="{{ asset('template/assets/images/team/1.jpg') }}">
                                </div>
                        ...
                        <div class="item">
                            <div class="team-card">
                                <div class="image-team">
                                    <img src="{{ asset('template/assets/images/team/2.jpg') }}">
                                </div>
                                <div class="team-content">
                                    <h3>Anderson john</h3>
                                    <p>Web Designer</p>
                        ...
                        <div class="item">
                            <div class="team-card">
                                <div class="image-team">
                                    <img src="{{ asset('template/assets/images/team/3.jpg') }}">
                                </div>
                                <div class="team-content">
                                    <h3>Sarah Se</h3>
                                    <p>Web Designer</p>
                        ...
                        <div class="item">
                            <div class="team-card">
                                <div class="image-team">
                                    <img src="{{ asset('template/assets/images/team/4.jpg') }}">
                                </div>
                                <div class="team-content">
                                    <h3>Williams</h3>
                                    <p>English </p>
